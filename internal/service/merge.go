...
func (s *Service) Merge(m *Message, r string, o *gitlab.MergeEvent, projectId int, channel string) {
    mergedBy, author := s.GetMergedBy(projectId, o.ObjectAttributes.IID)
